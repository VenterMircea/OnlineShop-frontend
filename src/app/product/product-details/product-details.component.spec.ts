...
describe('ProductDetailsComponent', () => {
  ...
  beforeEach(() => {
    ...
    product={
      ...
      "description": "deserunt tempor cupidatat proident do irure duis veniam laboris est non laborum velit nisi aute ullamco mollit dolor consequat tempor fugiat nisi voluptate non anim",
      "price": 7328.4,
      "rating": 4.8,
      "itemsInStock": 95,
  ...
  it('should bring the product data', () => {
    ...
    productService.getPageSize(product.id).subscribe(response=> expect(response).toBe(product));
  });
